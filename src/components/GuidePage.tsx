...
export function GuidePage({ onBack }: GuidePageProps) {
  return (
    <div className="w-full max-w-5xl mx-auto py-12 px-4 pb-24">
      <button 
        onClick={onBack}
        className="flex items-center space-x-2 text-sm font-medium text-slate-400 hover:text-indigo-900 transition-colors mb-10 group"
      >
      ...
      >
        <div className="flex flex-col items-center text-center space-y-4 mb-16">
          <div className="bg-indigo-50 border border-indigo-200 p-4 rounded-2xl">
            <BookOpen className="w-8 h-8 text-indigo-800" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-indigo-950 tracking-tight">Mode d'emploi</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {/* Text Guide */}
          <div className="bg-white p-8 md:p-10 rounded-[32px] border border-indigo-100 shadow-sm flex flex-col">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <h2 className="text-2xl font-semibold text-indigo-950 tracking-tight">Analyse Textuelle</h2>
            </div>
            <div className="space-y-4 text-slate-500 font-light leading-relaxed">
              ...
              <p>2. Allez sur la page <span className="font-medium text-indigo-700">Analyser</span> et collez le texte dans le grand champ prévu à cet effet.</p>
              <p>3. Cliquez sur le bouton <span className="font-medium text-indigo-700">Analyser le contenu</span>.</p>
          ...
          <div className="bg-white p-8 md:p-10 rounded-[32px] border border-indigo-100 shadow-sm flex flex-col">
            <div className="flex items-center space-x-4 mb-6">
              <div className="w-12 h-12 bg-indigo-50 border border-indigo-100 rounded-full flex items-center justify-center">
                <FileAudio className="w-6 h-6 text-indigo-700" />
              </div>
              <h2 className="text-2xl font-semibold text-indigo-950 tracking-tight">Analyse Audio (Deepfake)</h2>
            </div>
            <div className="space-y-4 text-slate-500 font-light leading-relaxed">
              <p>1. Sauvegardez le message vocal suspect sur votre téléphone ou ordinateur (formats .mp3 ou .wav supportés).</p>
              <p>2. Sur la page <span className="font-medium text-indigo-700">Analyser</span>, utilisez la zone pour <span className="font-medium text-indigo-700">Importer un audio</span>.</p>
              <p>3. Sélectionnez le fichier sur votre appareil puis cliquez sur <span className="font-medium text-indigo-700">Analyser le contenu</span>.</p>
        ...
        <div className="bg-indigo-50/50 p-8 md:p-12 rounded-[32px] border border-indigo-100 flex flex-col">
          <div className="flex items-center justify-center space-x-3 mb-10 text-center">
            <ShieldAlert className="w-6 h-6 text-indigo-800" />
            <h2 className="text-2xl md:text-3xl font-bold text-indigo-950 tracking-tight">Les 3 Règles d'Or</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h3 className="text-lg font-semibold text-indigo-950">L'Urgence est l'ennemie</h3>
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h3 className="text-lg font-semibold text-indigo-950">Raccrochez et Rappelez</h3>
              <p className="text-sm text-slate-500 font-light leading-relaxed">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h3 className="text-lg font-semibold text-indigo-950">Ne donnez rien</h3>
              <p className="text-sm text-slate-500 font-light leading-relaxed">
